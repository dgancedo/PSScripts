...
$vmdata = Get-VM -name * | Get-HardDisk | select @{N="VM";E={$_.Parent.Name}},@{N="CPU";E={$_.Parent.numCpu}},@{N="Memory Total MB";E={$_.Parent.memoryMb}},@{N="Provisioned Space";E={$_.Parent.ProvisionedSpaceGB}},@{N="Used Space";E={$_.Parent.UsedSpaceGB}},@{N="Storage GB";E={$_.CapacityGB}}

$hostdata = get-vmhost * | select Name,ConnectionState,Version,Manufacturer,Model,NumCpu,CpuTotalMhz,CpuUsageMhz,MemoryTotalGB,MemoryUsageGB
